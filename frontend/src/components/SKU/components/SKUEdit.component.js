        ...
        <>
            ...
            <Form>
                <Form.Group className="mb-3" controlId='formSkuName'>
                    ...
                    <Form.Control value={skuName} onChange={e => setSkuName(e.target.value)} type='text' placeholder='Enter name of SKU' />
                </Form.Group>
                <Form.Group className="mb-3" controlId='formSkuName'>
                    <Form.Label>SKU ID</Form.Label>
                    <Form.Control value={skuId} onChange={e => setSkuId(e.target.value)} type='text' placeholder='Enter ID of SKU' />
                </Form.Group>
                <Form.Group className="mb-3" controlId='formSkuMsrp'>
                    <Form.Label>MSRP $</Form.Label>
                    <Form.Control value={skuMsrp} onChange={e => setSkuMsrp(e.target.value)} type='number' placeholder='Enter MSRP' />
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Label>Style</Form.Label>
                    <Form.Control value={skuStyle} onChange={e => setSkuStyle(e.target.value)} type='text' />
                </Form.Group>
                <Form.Group className="mb-3">
                    <Form.Label>Color</Form.Label>
                    <Form.Control type='text' value={skuColor} onChange={e => setSkuColor(e.target.value)} />
                </Form.Group>
                <Form.Group className="mb-3">
